      ...
      >
        <div className="min-h-screen text-center">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 z-50 cursor-pointer bg-dark bg-opacity-0 sm:bg-opacity-10 sm:backdrop-blur sm:backdrop-filter-none sm:dark:bg-opacity-20" />
          </Transition.Child>
